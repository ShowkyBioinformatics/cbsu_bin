...
#   
#                  ____              ____                    _ 
# _ __ _   _ _ __ |  _ \ ___  _ __  / ___| ___ _ __    _ __ | |
#| '__| | | | '_ \| |_) / _ \| '_ \| |  _ / _ \ '_ \  | '_ \| |
#| |  | |_| | | | |  __/ (_) | |_) | |_| |  __/ | | |_| |_) | |
#|_|   \__,_|_| |_|_|   \___/| .__/ \____|\___|_| |_(_) .__/|_|
#                            |_|                      |_|      
#
...
#
#   
#   --PopGen                        outputs several population genetic statistics (Tajima's D, Fu and Li's D*, Fu and Li's F*)
#       --split_codon_sites         perform PopGen analysis on synonymous and nonsynonymous sites separately
#
#   --MK_test
#
...
&GetOptions (  
    ...
    'PopGen' => \$popgen_flag,
    'split_codon_sites' => \$split_sites_flag,
...
### This part will be temporarily edited to alow MK test without adding                 
            ...
            if ($split_sites_flag){
                system("rm $transcript.Syn.fasta $transcript.nonSyn.fasta");
            }
